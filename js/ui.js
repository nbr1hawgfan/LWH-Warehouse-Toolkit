window.LWHUI={
  ...
  show(view){document.querySelectorAll('.view').forEach(v=>v.classList.toggle('active',v.id===view));document.querySelectorAll('[data-view]').forEach(b=>b.classList.toggle('active',b.dataset.view===view));window.scrollTo(0,0);if(window.LWHLabels&&LWHLabels.setPrintPageSize)LWHLabels.setPrintPageSize(null,null);},
